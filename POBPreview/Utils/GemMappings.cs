...
{
	public static class GemMappings
	{
		public static List<string> RedGems = new List<string>
		{
		...
		{
			"poisonous concoction", "spectral helix", "void manipulation", "greater multiple projectiles",
